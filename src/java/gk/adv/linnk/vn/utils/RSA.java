...
public class RSA {
     ...
     */
    public static final String PRIVATE_KEY_FILE = ListionContext.ROOT_DIR + "/resource/rsa.key/private.key";
    /**
     * String to hold name of the public key file.
     */
    public static final String PUBLIC_KEY_FILE = ListionContext.ROOT_DIR + "/resource/rsa.key/public.key";
    // Key ------------
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
        ...
        System.out.println("PublicKey-getFormat:" + publicKey.toString());
