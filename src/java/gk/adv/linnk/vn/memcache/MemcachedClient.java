 ...
 * <br/>
 * Supports setting, adding, replacing, deleting compressed/uncompressed
 * and<br/>
 ...
 * </pre> The set method shown above will always set the object in the
 * cache.<br/>
...
public class MemcachedClient {
     ...
     * <br/>
     * Even if compression is disabled, compressed data will be
     * automatically<br/>
     * decompressed.
     *
     ...
     * the<br/>
     * specified time. However, {@link #set(String, Object) set} will
     * succeed,<br/>
    ...
    public long addOrIncr(String key, long inc, Integer hashCode) {
        boolean ret = set("add", key, inc, null, hashCode, true);
     ...
     * underflow. In the event of underflow, the result will be zero.
     * Because<br/>
     * Java lacks unsigned types, the value is returned as a 64-bit
     * integer.<br/>
     ...
     * that are not found are not entered into the hashmap, but attempting to
