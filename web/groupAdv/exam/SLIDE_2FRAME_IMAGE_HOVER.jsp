...
<html>
    ...
    <style>
        ...
        #linkvn_slide_28_Holder a, #linkvn_slide_28_Holder a:hover, #linkvn_slide_28_Holder a:visited, #linkvn_slide_28_Holder a:active {
            text-decoration: none !important;
        }
        #linkvn_slide_28_Holder a img {
        ...
        #linkvn_slide_28_Holder .banners:before, #linkvn_slide_28_Holder .banners:after {
            content: "";
            display: table;
        }
        #linkvn_slide_28_Holder .banners:after {
            clear: both;
        }
        #linkvn_slide_28_Holder .one_block {
            display: block;
            float: left;
            height: 140px;
            margin: 4.5px;
        ...
        #linkvn_slide_28_Holder .one_block:before, #linkvn_slide_28_Holder .one_block:after {
            content: "";
            display: table;
        }
        #linkvn_slide_28_Holder .one_block:after {
            clear: both;
        }
        #linkvn_slide_28_Holder .one_block .banner-face-front {
            position: relative;
        }
        #linkvn_slide_28_Holder .one_block .banner-face-front img {
            float: left;
            height: 110px;
            padding: 5px 15px;
            width: 110px;
        }
        #linkvn_slide_28_Holder .one_block .banner-face-front span {
        ...
        #linkvn_slide_28_Holder .one_block .banner-face-front span strong, #linkvn_slide_28_Holder .one_block .banner-face-front span em {
            color: #3e3e3f;
            display: block;
        }
        #linkvn_slide_28_Holder .one_block .banner-face-front span em {
        ...
        #linkvn_slide_28_Holder .one_block .banner-face-front span price {
            background: none repeat scroll 0 0 rgba(0, 0, 0, 0);
            color: #e91e23;
            font-size: 14px;
            font-weight: bold;
        }
        #linkvn_slide_28_Holder .one_block .banner-face-front span del {
            background: none repeat scroll 0 0 rgba(0, 0, 0, 0);
            color: black;
            font-size: 11px;
            font-weight: 500;
        ...
        #linkvn_slide_28_Holder .one_block .banner-face-front span .discount {
            background: none repeat scroll 0 0 rgba(255, 0, 0, 0.7);
            float: right;
            height: 37px;
            width: 37px;
        }
        #linkvn_slide_28_Holder .one_block .banner-face-front:hover span {
            background: none repeat scroll 0 0 #81dafc;
            top: 0 !important;
            z-index: 1002;
        }
        #linkvn_slide_28_Holder .one_block em {
            font-weight: bold;
            text-align: right !important;
        }
        #linkvn_slide_28_Holder .one_block.banner-widget price {
            text-align: right !important;
        }
        #linkvn_slide_28_Holder .one_block.banner-widget price {
            line-height: 12px;
        }
        #linkvn_slide_28_Holder .one_block.banner-widget strong {
            margin: 10px 0;
            text-align: right !important;
        }
        #linkvn_slide_28_Holder .one_block.banner-context .banner-face-front span strong {
            font-family: arial;
            font-size: 11px;
            font-size-adjust: none;
            font-stretch: normal;
    ...
    <body>
        ...
        <script>
            ...
            function linkvn_initSlide_28(rtl) {
                if (rtl == 1) {
                    rtl = LinkslideIt_28(-298);
                } else {
                    rtl = LinkslideIt_28(0);
                }
            }
            setTimeout(function() {
                linkvn_initSlide_28(1);
            }, 5000);
        </script>
    </body>
</html>
