...
<html>
    ...
    <style>
        #ads_linkvn_zone_28_slot10{
            ...
            font-size:11px;
            background-image:url('/resource/images/bgRotate.jpg'); 
    ...
    <body>
        ...
        <script>
            function changeRotation(deg, elId) {
            ...
            function getcurrentRatation(elId) {
                var el = document.getElementById(elId);
            ...
            function LinkVnRatation(wktf) {
                var a = document.getElementById("linkvn_slotOne");
                var b = document.getElementById("linkvn_slotTwo");
                if (wktf != 180) {
                    wktf = wktf + 1;
                    changeRotation(wktf, 'linkvn_slotOne');
                    setTimeout(function() {
                        LinkVnRatation(wktf, 'linkvn_slotOne');
                    }, 10);
                    if (a.className.indexOf("slide_boder") == -1) {
                        a.className = a.className + " slide_boder";
                    }
                } else {
                    var tmp = a.innerHTML; 
                    changeRotation(0, 'linkvn_slotOne');
                    a.innerHTML = b.innerHTML;
                    b.innerHTML = tmp;
                    a.className = a.className.replace("slide_boder", "");
                    setTimeout(function() {
                        LinkVnRatation(0);
                    }, 5000);
                }
