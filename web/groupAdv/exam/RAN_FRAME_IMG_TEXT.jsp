...
<html>
    ...
    <style>
        ...
        #ads_linkvn_zone_28_slot10 #2frame_linkvn_slotOne,
        #ads_linkvn_zone_28_slot10 #2frame_linkvn_slotTwo{
            padding: 0;
            overflow: hidden;
            width: 298px;
            height: 598px;
    ...
    <body>
        ...
        <script>
            function LinkslideIt(dl) {
                var a = document.getElementById("2frame_linkvn_slotOne");
                var b = document.getElementById("2frame_linkvn_slotTwo");
                if (dl == 0) {
            ...
            function linkvn_init_random(dl) {
                dl = LinkslideIt(dl);
                setTimeout(function() {
                    linkvn_init_random(dl);
                }, 5000);
            }
            setTimeout(function() {
                linkvn_init_random(0);
            }, 5000);
        </script>
    </body>
</html>
