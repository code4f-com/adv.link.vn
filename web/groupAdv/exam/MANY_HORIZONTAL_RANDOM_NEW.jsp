...
<html>
    <head>
        ...
        <style>
            ...
            #ads_link_zone_57 .ssvzTop, #ads_link_zone_57 .ssvzBottom {
                clear: both;
                height: 3px;
                overflow: hidden;
            }
            #ads_link_zone_57 .ssvzclear {
                clear: both;
            }
            #ads_link_zone_57 #ads_link_zone_57_items {
                height: 157px;
                margin: 0;
                overflow: hidden;
                padding: 0;
            }
            #ads_link_zone_57_items .adv_items {
                float: left;
                height: 150px;
                margin: 5px 10px;
                width: 222px;
            }
            #ads_link_zone_57_items .adv_items .ssvzimage {
                clear: both;
            }
            #ads_link_zone_57_items .adv_items .ssvzimage img {
            ...
            #ads_link_zone_57_items .adv_items .ssvzTitle {
                clear: both;
                height: 32px;
                line-height: 15px;
                text-align: left;
            }
            #ads_link_zone_57_items .adv_items .ssvzTitle a:link, #ads_link_zone_57_items .adv_items .ssvzTitle a:visited {
                color: #333333;
            ...
            #ads_link_zone_57_items .itemmc, #ads_link_zone_57_items .itemmc a:visited, #ads_link_zone_57_items .itemmc a:active, #ads_link_zone_57_items .itemmc a:link {
                color: #666666;
                margin-bottom: 2px;
                text-decoration: none;
            }
            #ads_link_zone_57_items .adv_items .price {
                height: 87px;
                line-height: 16px;
                padding-left: 5px;
                text-align: left;
            }
            #ads_link_zone_57_items .adv_items .price a:link, #ads_link_zone_57_items .adv_items .price a:visited {
                color: #333333;
                font-family: Tahoma;
                font-size: 11px;
                font-weight: 400;
            ...
            #ads_link_zone_57_items .ssvzBorder {
    ...
    <body>
        ...
        <script>
            function LinkslideIt_57(dl) {
                var a = document.getElementById("2frame_linkvn_57_slotOne");
                var b = document.getElementById("2frame_linkvn_57_slotTwo");
                if (dl == 0) {
            ...
            function linkvn_init_57_random(dl) {
                dl = LinkslideIt_57(dl);
                setTimeout(function() {
                    linkvn_init_57_random(dl);
                }, 5000);
            }
            setTimeout(function() {
                linkvn_init_57_random(0);
            }, 5000);
        </script>
    </body>
</html>
