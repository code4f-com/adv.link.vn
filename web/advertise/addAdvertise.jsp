        ...
        <%
            ...
            if (req.getParameter("submit") != null) {
                ...
                if (kind == Advertise.KIND.FLASH.getValue()) {
                    ...
                    int height = RequestTool.getInt(req, "height");
                    int status = RequestTool.getInt(req, "status");
                    MultipartFile file1x1 = req.getFileParameter("image");
                    ...
                    advDao.setStatus(status);
                    advDao.setCreateBy(adminInfo.getAccID());
                    if (advDao.addNewImage(advDao, file1x1, file1x2, zoom)) {
                        session.setAttribute("mess", "Thêm mới dữ liệu thành công!");
                        out.print("<script>location.href = '" + request.getContextPath() + "/sys-admin/advertise-manager/show.html?kind=" + kind + "'</script>");
                        return;
                    } else {
...
//                    Tool.Debug("region: " + region);
                    ...
                    Tool.Debug("Chang thuoc cai the loai boi nao ??:" + kind);
                }
                //------------
            }
        %>
                    ...
                    <div class="right_content">
                        ...
                        <div class="tabbed_area">
                            ...
                            <div id="tab1" class="content">
                                <%@include file="/advertise/tem/addImageAndText.jsp" %>
                            </div>
                            ...
                            <div id="tab4" class="content">
                                <%@include file="/advertise/tem/addImageAndprices.jsp" %>
                            </div>
                        </div>
