...
(function($) { // create private scope (inside you can use $ instead of jQuery)
    ...
    var months = 'Tháng 1,Tháng 2,Tháng 3,Tháng 4,Tháng 5,Tháng 6,Tháng 7,Tháng 8,Tháng 9,Tháng 10,Tháng 11,Tháng 12'.split(',');
    ...
    $.fn.simpleDatepicker = function(options) {
        ...
        function formatDate2MMddyyyy(date)
        {
            if(date== null || date == "") 
                return date; 
            else
        ...
        function newDatepickerHTML () {
            ...
            // build the table structuredatepicker
            ...
            jQuery("thead",table).append('<tr class="days"><th style="color: red">CN</th><th>T2</th><th>T3</th><th>T4</th><th>T5</th><th>T6</th><th style="color: red">T7</th></tr>');
            jQuery("tfoot",table).append('<tr><td colspan="3"></td><td colspan="2">&nbsp;</td><td colspan="2"><span class="today">Hôm nay</span></td></tr>');
            ...
            if ( jQuery(this).is('input') && 'text' == jQuery(this).attr('type')) {
                ...
                jQuery(this).click(function (ev) {
                    ...
                    if (false == jQuery.data($this.get(0), "simpleDatepicker").hasDatepicker) {
                        ...
                        var initialDate = formatDate2MMddyyyy($this.val());
...
//                        });
                    ...
                    $(document).click(function (ev) {                    
                        var $ele = jQuery(ev.target);
                        if(datepicker != undefined && !$ele.is(".dateproc") 
                            && !$ele.is(".nextMonth") && !$ele.is(".prevMonth")
                            && !$ele.is("select[name=month]") && !$ele.is("select[name=year]")
                            && !$ele.is("option"))
                        {
                            closeIt($this, datepicker);
                        }                
