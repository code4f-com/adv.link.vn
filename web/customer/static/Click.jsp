...
<html >
    ...
    <body>
        <%
            ...
            int totalPage = 0;
            int totalRow = analyDao.getCustomerCountClick(startTime, endTime, temDomain, locationID, adsId, adminInfo.getAccID());
            totalPage = (int) totalRow / rowPerPage;
            if (totalRow % rowPerPage != 0) {
                totalPage++;
            }
            ArrayList<AnalyticsAll> all = analyDao.getCustomerClick(currentPage, startTime, endTime, temDomain, locationID, adsId, rowPerPage, adminInfo.getAccID());
        %>
                            ...
                            <table id="rounded-corner" align="center">
                                ...
                                <script>
                                    function changeRowView(val) {
                                        ...
                                        location.href = "<%=request.getContextPath()%>/customer/statistic/click.html?rowPerPage=" + val;
                                    }
                                </script>
                                <tr align="center">
                                    <td colspan="3">
