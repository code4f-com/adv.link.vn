<%@page import="com.ckeditor.CKEditorConfig"%><%@page import="gk.adv.linnk.vn.object.Advertise"%><%@page import="gk.adv.linnk.vn.multipart.request.MultipartFile"%><%@page import="gk.adv.linnk.vn.utils.RequestTool"%><%@page import="gk.adv.linnk.vn.multipart.request.HttpServletMultipartRequest"%>
        ...
        <%
            ...
            if (req.getParameter("submit") != null) {
                ...
                if (kind == Advertise.KIND.FLASH.getValue()) {
                    ...
                    advDao.setAdsBy(Advertise.ADSBY.CUSTOMER.getValue());
                    advDao.setUpdateBy(adminInfo.getAccID());
                    if (advDao.updateImage(advDao, file)) {
                        session.setAttribute("mess", "Cập nhật dữ liệu thành công!");
                        out.print("<script>location.href = '" + request.getContextPath() + "/customer/ads/manager.html'</script>");
                        return;
                    } else {
            ...
            <div class="main_content">
                ...
                <div class="center_content">
                    <div class="right_content">
                        ...
                        %>
                        <%@include file="/customer/ads/tem/editImageText.jsp" %>
                        <%} else if (kind == Advertise.KIND.IMAGE.getValue()) {
                        %>
                        <%@include file="/customer/ads/tem/editImage.jsp" %>
                        <%                        } else if (kind == Advertise.KIND.FLASH.getValue()) {
                        %>
                        <%@include file="/customer/ads/tem/editFlash.jsp" %>
                        <%                        } else if (kind == Advertise.KIND.IMAGE_PRICE.getValue()) {
                        %>
                        <%@include file="/customer/ads/tem/editImagePrice.jsp" %>
                        <%                            }
                        %>
