...
<%
    ...
    if (adminInfo == null) {
        ...
        if (adminInfo.getUserType() == Account.TYPE.USER.val) {
            ...
            System.out.println("Customer Access ["+BuildCache.DOMAIN+"] user: " + adminInfo.getUserName() + "---" + DateProc.createTimestamp());
            return;
        } else {
            System.out.println("Admin Access ["+BuildCache.DOMAIN +"] user: " + adminInfo.getUserName() + "---" + DateProc.createTimestamp());
        }
    }
    //---------PAGE SETING----------------
    String pageURL = "";
