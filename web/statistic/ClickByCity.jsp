...
<html >
    ...
    <body>
        <%
            ...
            String city = Tool.validStringRequest(request.getParameter("city"));
            ...
            int totalPage = 0;
            int totalRow = analyDao.getCountAnalyticClickByCity(startTime, endTime, domain, city, adsId);
            totalPage = (int) totalRow / rowPerPage;
            if (totalRow % rowPerPage != 0) {
                totalPage++;
            }
            ArrayList<AnalyticsAll> all = analyDao.getAnalyticClickByCity(currentPage, startTime, endTime, domain, city, adsId, rowPerPage);
        %>
                            ...
                            <table id="rounded-corner" align="center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>Thành phố:</td>
                                        <td><input size="75" type="text" name="city"/></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td>Tên Miền:</td>
                                ...
                                <script>
                                    function changeRowView(val) {
                                        ...
                                        location.href = "/sys-admin/statistic/city/click.html?rowPerPage=" + val;
                                    }
                                </script>
                                <tr align="center">
                                    <td colspan="3">
                        ...
                        <table align="center" id="rounded-corner" summary="Gk Joint Stock Company" >
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="rounded-q4">Lượt Click</th>
                                </tr>
                            </thead>
                            <tbody>
                                <%
                                ...
                                <tr>
                                    <td></td>
                                    <td><%=stt++%></td>
                                    <td style="border-right: solid 1px #00ccff" align="center"><%= oneAnalytic.getCity()%></td>
