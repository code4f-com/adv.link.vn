...
<html >
    ...
    <body>
        <%
            ...
            all = dao.listAll(Account.TYPE.ADMIN.val,null);
        %>
                ...
                <div class="center_content">
                    <div class="right_content">
                        ...
                        <div align="center" style="height: 20px;margin-bottom: 12px;margin-top: 10px">
                            <%if(adminInfo.checkAdd(request)) {%><a href="<%=request.getContextPath()+"/sys-admin/account-manager/add.html"%>"><img border="0"  src="<%= request.getContextPath()%>/resource/images/add_1.gif"/></a><%}%>
                        </div>
                        <!--Content-->
                        <table align="center" id="rounded-corner" summary="Msc Joint Stock Company" >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <%if(adminInfo.checkEdit(request)) {%><td><a href="<%=request.getContextPath()+"/sys-admin/account-manager/role-"+oneAdmin.getAccID()+".html" %>">Quyền</a></td><%}%>
                                    <%if(adminInfo.checkEdit(request)) {%><td><a href="/sys-admin/account-manager/edit-<%=oneAdmin.getAccID()%>.html"><img src="<%= request.getContextPath()%>/resource/images/user_edit.png" alt="" title="" border="0" /></a></td><%}%>
                                    <%if(adminInfo.checkDel(request)) {%><td><a href="/sys-admin/account-manager/del-<%=oneAdmin.getAccID()%>.html" class="ask"><img src="<%= request.getContextPath()%>/resource/images/trash.png" alt="" title="" border="0" /></a></td><%}%>
                                </tr>
                                <%
                                    }
                                %>
