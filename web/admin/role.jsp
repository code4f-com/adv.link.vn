<%@page import="gk.adv.linnk.vn.admin.Groups"%><%@page import="gk.adv.linnk.vn.admin.Permission"%><%@page import="gk.adv.linnk.vn.utils.RequestTool"%><%@page import="java.util.Iterator"%><%@page import="java.util.ArrayList"%>
            ...
            <div class="main_content">
                ...
                <div class="center_content">
                    <div class="right_content">
                                ...
                                <tr>
                                    ...
                                    <th colspan="2" scope="col" class="rounded-q4">
                                        <span style="text-align: center;font-weight: bold;color: blueviolet;margin-right: 10px">
                                            QUYỀN CỦA USER: <span class="redBold"> <%=accDao.getUserName()%></span>
                                        </span>
                                    </th>
                                </tr>
                            </thead>
                        ...
                        <!--Content-->
                        <form action="/admin/role-process.jsp" name="frmARole" id="frmGRole" method="post">
                            <table align="center" id="rounded-corner" summary="Msc Joint Stock Company" >
                                <thead>
                                    <tr>
                                        ...
                                        <th align="center" scope="col" class="rounded-q4 boder_right">Delete<br/><input id="checkdel" onclick="checkall('del')" value="" name="checkDelete" type="checkbox" /></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <%
                                ...
                                <td align="center">                    <input value="<%=accId + "_" + onePer.getModelId()%>" <%=onePer.isDel() ? "checked='true'" : ""%> type="checkbox" name="del"/></td>
                                </tr>
                                <%}%>
                                <tr align="center">
                                    <td colspan="8">
                                        ...
                                        &nbsp;&nbsp;
                                        <input value="Quay về" type="button" onclick="location.href = '<%=request.getContextPath() + "/sys-admin/account-manager/show.html"%>'"/>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
