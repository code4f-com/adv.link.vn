...
<html >
    ...
    <body>
        <%if (!adminInfo.checkEdit(request)) {
            ...
            all = dao.listAll(Account.TYPE.ADMIN.val, key);
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <%if (GroupAccDetail.checkExitAcc(oneAdmin.getAccID(), g)) {
                                                out.print("<a href='" + request.getContextPath() + "/admin/group/removeAcc.jsp?gid=" + groupId + "&uid=" + oneAdmin.getAccID() + "' class='ask'><img title='Remove From Group' src='/resource/images/remove.png'/></a>");
                                            } else {%>
                                        <a class="ask" href="<%=request.getContextPath() + "/sys-admin/group-manager/" + groupId + "-" + oneAdmin.getAccID()%>">Add to Group</a>
                                        <%}%>
                                    </td>
                                    <td align="center">
