            ...
            <div class="main_content">
                ...
                <div class="center_content">
                    <div class="right_content">
                        ...
                        <!--Content-->
                        <form action="<%= request.getContextPath() + "/sys-admin/group-role/process-role.html"%>" name="frmGRole" id="frmGRole" method="post">
                            <table align="center" id="rounded-corner" summary="Msc Joint Stock Company" >
                                ...
                                <td align="center">                    <input value="<%=gid + "_" + onePer.getModelId()%>" <%=onePer.isDel() ? "checked='true'" : ""%> type="checkbox" name="del"/></td>
                                </tr>
                                <%}%>
                                <tr align="center">
                                    <td colspan="8">
                                        ...
                                        &nbsp;&nbsp;
                                        <input value="Quay về" type="button" onclick="location.href = '<%=request.getContextPath() + "/sys-admin/group-manager/show.html"%>'"/>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
