<%@page import="gk.adv.linnk.vn.utils.RequestTool"%><%@page import="gk.adv.linnk.vn.admin.Groups"%>
    ...
    <body>
        <%
            ...
            if (request.getParameter("submit") != null) {
                ...
                boolean status = Tool.getBooleanStatus(request.getParameter("status"));
                //---
                oneGroup.setName(name);
                oneGroup.setDescription(desc);
                oneGroup.setUpdateBy(adminInfo.getAccID());
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="4" align="center">
                                            ...
                                            <input onclick="window.location.href = '<%=request.getContextPath() + "/sys-admin/group-manager/show.html"%>'" type="reset" name="reset" value="Hủy"/>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
